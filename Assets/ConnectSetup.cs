...
using System.Text;
using System.Threading;
public class ConnectSetup : MonoBehaviour
{
    //20221112 CT - This class will contain our connection setup for test RDP connection to EC2
    //This will be extended in future to allow for dynamic connections to different virtual machines

    //this value holds the id of remote machine
    public int hostId;

    //this value holds port of remote connection
    public int hostPort;
    ...
    void Initialize()
    {
        ...
        //ec2 details
        hostPort = 3389;
        hostAddress = "3.248.194.179";
        userName = "Administrator";
        connectPassword = "BDz2l$9(PshfCXLkHfLU(60-;ylq5VzM";
        clientIP = GetMyIp();
